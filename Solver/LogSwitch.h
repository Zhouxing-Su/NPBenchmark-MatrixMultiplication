...
#ifndef SMART_SZX_MATRIX_MULTIPLICATION_LOG_SWITCH_H
#define SMART_SZX_MATRIX_MULTIPLICATION_LOG_SWITCH_H
...
#endif // SMART_SZX_MATRIX_MULTIPLICATION_LOG_SWITCH_H
